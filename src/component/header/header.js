      ...
      <div className="container">
        <div className="headerContent">
          ...
          {/* <div className='dropdown'>
                <a href='#'><img className='configMenuBtn'
                src={require('../../assets/img/icon-settings.svg')} alt='settings'></img></a>
          ...
          <div className="dropdown">
            ...
            src={require('../../assets/img/icon-settings.svg')} alt='settings'></img> */}
